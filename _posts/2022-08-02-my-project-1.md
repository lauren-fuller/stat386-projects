...
`movie_profit = html_code.find_all( "div", class_ = "card-content")`
<br />

`results = html_code.find(id = "ResultsContainer")`
...
<img src="https://i.postimg.cc/8cSfm64m/Screen-Shot-2022-10-21-at-12-20-24-AM.png" alt="drawing" width="650"/>

Now that we have a list of the urls,
